...
import Logo from '../../../public/TeamSyncTracklogo.png';
    ...
    return (
        <header
            ...
            <Link
                ...
                <Image
                    src={Logo}
                    alt="TeamSyncTrack Logo"
                    width={25}
                    height={25} />
                <span
                    className="font-semibold dark:text-white">TeamSyncTrack
                </span>
            </Link>
                        ...
                        <NavigationMenuContent>
                            <ul className="grid w-[400px] gap-3 p-4  md:grid-row-2  ">
                                <ListItem
                                    title={'Master Plan'}
                                    href={'#pricing'}>
                                    The Best way for a Enterprice level team with own Customisation.
                                </ListItem>
                                <ListItem
                                    title="Pro Plan"
                                    href={'#pricing'}>
